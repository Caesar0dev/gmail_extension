      ...
      change.addedNodes[0] &&
        change.addedNodes.forEach((node) => {
          ...
          if (
            ...
            certalinkView.style.display = window.location.hash.length > 30 ? "block" : "none";
            if (document.getElementById("messageView")) {
              ...
              if (window.location.hash.length > 30) {
                document.getElementById("messageView").children[0].src = "https://portal.certalink.com/version-test/messageview?sender=" + auth.inboxEmail + auth.inboxName;
              }
            }
            ...
            if (document.getElementById("inboxView")) {
              document.getElementById("inboxView").style.display = window.location.hash.length < 30 ? "block" : "none";
            }
          }
        });
    });
